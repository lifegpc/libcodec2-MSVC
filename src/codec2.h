...
CODEC2_PUBLIC struct CODEC2 *  codec2_create(int mode);
CODEC2_PUBLIC void codec2_destroy(struct CODEC2 *codec2_state);
CODEC2_PUBLIC void codec2_encode(struct CODEC2 *codec2_state, unsigned char * bits, short speech_in[]);
CODEC2_PUBLIC void codec2_decode(struct CODEC2 *codec2_state, short speech_out[], const unsigned char *bits);
CODEC2_PUBLIC void codec2_decode_ber(struct CODEC2 *codec2_state, short speech_out[], const unsigned char *bits, float ber_est);
CODEC2_PUBLIC int  codec2_samples_per_frame(struct CODEC2 *codec2_state);
CODEC2_PUBLIC int  codec2_bits_per_frame(struct CODEC2 *codec2_state);

CODEC2_PUBLIC void codec2_set_lpc_post_filter(struct CODEC2 *codec2_state, int enable, int bass_boost, float beta, float gamma);
CODEC2_PUBLIC int  codec2_get_spare_bit_index(struct CODEC2 *codec2_state);
CODEC2_PUBLIC int  codec2_rebuild_spare_bit(struct CODEC2 *codec2_state, int unpacked_bits[]);
CODEC2_PUBLIC void codec2_set_natural_or_gray(struct CODEC2 *codec2_state, int gray);
CODEC2_PUBLIC void codec2_set_softdec(struct CODEC2 *c2, float *softdec);
CODEC2_PUBLIC float codec2_get_energy(struct CODEC2 *codec2_state, const unsigned char *bits);
      
// support for ML and VQ experiments
CODEC2_PUBLIC void codec2_open_mlfeat(struct CODEC2 *codec2_state, char *filename);
CODEC2_PUBLIC void codec2_load_codebook(struct CODEC2 *codec2_state, int num, char *filename);
CODEC2_PUBLIC float codec2_get_var(struct CODEC2 *codec2_state);
CODEC2_PUBLIC float *codec2_enable_user_ratek(struct CODEC2 *codec2_state, int *K);

// 700C post filter and equaliser
CODEC2_PUBLIC void codec2_700c_post_filter(struct CODEC2 *codec2_state, int en);
CODEC2_PUBLIC void codec2_700c_eq(struct CODEC2 *codec2_state, int en);
