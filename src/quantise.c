...
{
  int i, n1, n2, n3;
  float* err = (float*)malloc(order * sizeof(float)), * err2 = (float*)malloc(order * sizeof(float)), * err3 = (float*)malloc(order * sizeof(float));
  float* w = (float*)malloc(order * sizeof(float)), * w2 = (float*)malloc(order * sizeof(float)), * w3 = (float*)malloc(order * sizeof(float));
...
float lspmelvq_quantise(float *x, float *xq, int order)
{
  ...
  float* tmp = (float*)malloc(order * sizeof(float));
  float mse;
